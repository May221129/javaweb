...
<body>
	...
	<jsp:useBean id="customer" class="com.llm.a03cookie.a03.javabean.Customer" 
		scope="request"></jsp:useBean>
	
	<jsp:useBean id="customer2" beanName="com.llm.a03cookie.a03.javabean.Customer"
		type="java.lang.Object" scope="request"></jsp:useBean>
		
	<%-- 
		Object customer2 = request.getAttribute("customer2");
		if(customer2 == null){
			customer2 = Class.forName("com.llm.a03cookie.a03.javabean.Customer").newInstance();
	...
	<%-- 
		//1. 从 scope(session) 中获取 id(customer) 属性值, 赋给 class(com.llm.a03cookie.a03.javabean.Customer) 
		//类型的 id(customer) 变量
		...
		if(customer == null){
			customer = (Customer)Class.forName("com.llm.a03cookie.a03.javabean.Customer").newInstance();
