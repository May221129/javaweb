...
<body>
	...
	<%-- 
	<%= 
		为什么我上面el代码中写name[0].class.name会报错？老师的没报错，而我在el1中也有些name数组。
		==》阿帕奇的配置文件的设置问题，而且这个阿帕奇是eclipse中的
	...
	<!-- 3. EL 可以进行自动的类型转换 -->
	score: ${param.score + 1000}
	<br>
	<!-- jsp里的Java代码不能进行自动类型转换 -->
	score: <%= request.getParameter("score") + 1000 %>
	<br>
	
	我在EL1的超链接中设置的score值为:score: ${param.score}
	<br>
	...
	<% 
		...
		customer.setName("ATLLM");	
	
		session.setAttribute("com.llm.a03cookie.a03.javabean.customer", customer);
	%>
	
	<br>
	<!--  如果域对象中的属性名带有特殊字符, 则使用 [] 运算符会很方便. -->
	name: ${sessionScope["com.llm.a03cookie.a03.javabean.customer"].name }
