...
public class UserDao {
	...
	static{
		...
		authorities.add(new Authority("Article-1", "/a07filte_a01_authority5/article-1.jsp"));
		authorities.add(new Authority("Article-2", "/a07filte_a01_authority5/article-2.jsp"));
		authorities.add(new Authority("Article-3", "/a07filte_a01_authority5/article-3.jsp"));
		authorities.add(new Authority("Article-4", "/a07filte_a01_authority5/article-4.jsp"));
