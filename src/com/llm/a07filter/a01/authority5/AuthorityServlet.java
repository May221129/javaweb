...
public class AuthorityServlet extends HttpServlet {
	...
	public void getAuthorities(HttpServletRequest request,
		...
		request.getRequestDispatcher("/a07filte_a01_authority5/authority-manager.jsp").forward(request, response);
	}
	...
	public void updateAuthority(HttpServletRequest request,
		...
		response.sendRedirect(request.getContextPath() + "/a07filte_a01_authority5/authority-manager.jsp");
	}
}
